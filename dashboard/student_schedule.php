...
// Placeholder page for student schedule.
...
<div class="flex flex-col lg:flex-row">
    ...
    <main class="flex-1 p-6 bg-gradient-to-br from-gray-50 to-gray-100">
        <div class="max-w-5xl mx-auto">
            <h1 class="text-3xl font-bold text-gray-800 mb-6">Student Schedule</h1>
            <div class="bg-white rounded-xl shadow-lg p-6">
                <p class="text-gray-600">This is the student schedule page. Schedule details will be displayed here.</p>
